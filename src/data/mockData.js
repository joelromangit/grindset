  ...
  subjects: [
    {
          ...
          theoryBlocks: [
            {
              ...
              exercises: [
                ...
                },
                {
                  id: 3,
                  type: "auto",
                  question: "La matriz identidad $I_3$ tiene en la posicion $a_{23}$ el valor:",
                ...
                },
                {
                  id: 4,
                  type: "manual",
                  question: "Escribe una matriz cuadrada de $3 \\times 3$ donde la diagonal principal sean los numeros $2, 5, 8$ y el resto sean ceros. Luego indica que tipo de matriz es y escribe la matriz identidad $I_3$.",
                  autoConfig: null,
                  status: "pending",
                  studentAnswer: null,
                  photoUrl: null
            ...
            },
            {
              ...
              exercises: [
                ...
                },
                {
                  id: 7,
                  type: "manual",
                  question: "Dadas $A = \\begin{pmatrix} 1 & 2 \\\\ 3 & 4 \\end{pmatrix}$ y $B = \\begin{pmatrix} 5 & 6 \\\\ 7 & 8 \\end{pmatrix}$, calcula paso a paso: a) $A + B$, b) $A - B$, c) $3A - 2B$",
                  autoConfig: null,
                  status: "pending",
                  studentAnswer: null,
                  photoUrl: null
                },
                {
                  id: 8,
                  type: "manual",
                  question: "Calcula $2 \\cdot \\begin{pmatrix} 1 & 0 & -2 \\\\ 3 & 1 & 4 \\end{pmatrix} + 3 \\cdot \\begin{pmatrix} -1 & 2 & 1 \\\\ 0 & -1 & 2 \\end{pmatrix}$. Muestra cada paso.",
                  autoConfig: null,
                  status: "pending",
                  studentAnswer: null,
                  photoUrl: null
                },
                {
                  id: 9,
                  type: "manual",
                  question: "Si $A + B = \\begin{pmatrix} 5 & 3 \\\\ 1 & 7 \\end{pmatrix}$ y $A = \\begin{pmatrix} 2 & 1 \\\\ 0 & 4 \\end{pmatrix}$, encuentra la matriz $B$. Comprueba tu resultado sumando $A + B$.",
                  autoConfig: null,
                  status: "pending",
                  studentAnswer: null,
                  photoUrl: null
            ...
            },
            {
              ...
              exercises: [
                ...
                },
                {
                  id: 12,
                  type: "manual",
                  question: "Calcula la traspuesta de $A = \\begin{pmatrix} 2 & -1 & 0 \\\\ 3 & 4 & -5 \\end{pmatrix}$ e indica las dimensiones de $A$ y de $A^T$.",
                  autoConfig: null,
                  status: "pending",
                  studentAnswer: null,
                  photoUrl: null
                },
                {
                  id: 13,
                  type: "manual",
                  question: "Dada $B = \\begin{pmatrix} 1 & 3 \\\\ 3 & 2 \\end{pmatrix}$, calcula $B^T$ y comprueba si $B$ es simetrica (es decir, si $B = B^T$).",
                  autoConfig: null,
                  status: "pending",
                  studentAnswer: null,
                  photoUrl: null
      ...
      weeklyPlan: [
        { day: "Lunes", task: "Estudiar Matrices", topic: "Matrices", done: false },
        { day: "Martes", task: "Ejercicios Matrices", topic: "Matrices", done: false },
        { day: "Miercoles", task: "Estudiar Sistemas de ecuaciones", topic: "Sistemas de ecuaciones", done: false },
        { day: "Jueves", task: "Ejercicios Sistemas de ecuaciones", topic: "Sistemas de ecuaciones", done: false },
        { day: "Viernes", task: "Repaso Matrices y Sistemas", topic: "Matrices", done: false },
        { day: "Sabado", task: "Estudiar Probabilidad", topic: "Probabilidad", done: false },
        { day: "Domingo", task: "Descanso activo - repasar apuntes", topic: "", done: false }
      ]
    }
  ]
};
